...
from nerfstudio.models.simple_nerf import SimpleNeRFModelConfig
...
descriptions = {
    ...
    "simple-nerf": "Simple NeRF model with augmented networks supervision (& DS-NeRF depth-supervision). (slow)",
    "tensorf": "tensorf",
...
method_configs["simple-nerf"] = TrainerConfig(
    method_name="simple-nerf",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    mixed_precision=True,
